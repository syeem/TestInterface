========================================================================
    ACTIVE TEMPLATE LIBRARY : TestInterface Project Overview
========================================================================

AppWizard has created this TestInterface project for you to use as the starting point for
...
TestInterface.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (TestInterface.h)
        GUID definitions                                (TestInterface_i.c)
        A type library                                  (TestInterface.tlb)
        Marshaling code                                 (TestInterface_p.c and dlldata.c)

TestInterface.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in TestInterface.idl. It will be regenerated by MIDL during compilation.
...
TestInterfaceps.vcxproj
	...
	dlldata.c, TestInterface_i.c and TestInterface_p.c which are required
	to build the proxy/stub DLL.

TestInterfaceps.vcxproj.filters
